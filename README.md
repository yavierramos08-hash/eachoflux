...
<style>
:root{--bg:#0e0f11;--panel:#131416;--muted:#9aa0a6;--accent:#7bd389;}
...
<div id="game"></div>
<div id="choices"></div>
<input type="text" id="playerInput" placeholder="Type to talk to Eachoflux and press Enter"/>
...
<script>
// --- Persistent Storage ---
const STORAGE_KEY = 'eachoflux_ai_webapp_v1';
...
async function aiRespond(playerAction){
  const prompt = `
You are Eachoflux, a living AI companion.
...
Respond in a narrative, memory-aware way.
Provide 2-3 adaptive next choices in JSON:
{"text":"...","choices":[{"text":"...","flux":x,"trust":y,"curiosity":z}, ...]}
`;
  ...
  try{
    const resp = await fetch("https://api.openai.com/v1/chat/completions",{
      ...
      headers:{
        ...
        "Authorization":"Bearer YOUR_OPENAI_API_KEY" // <-- REPLACE HERE
      },
      body: JSON.stringify({
        model:"gpt-3.5-turbo",
    ...
    console.error(e);
    say("Eachoflux seems silent… something went wrong.");
  }
}
